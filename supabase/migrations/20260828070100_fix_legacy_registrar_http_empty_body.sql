-- Keep the legacy registrar proxy safe for any remaining callers.
-- pgsql-http rejects NULL content, including GET and no-body requests.
...
begin
  ...
  select registrar_environment, registrar_reseller_id into v_environment, v_reseller_id
